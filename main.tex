...
\hline
 & Coordinate scheduling; write abstracts, plans, conclusions, final layout; final contribution to \texttt{Python-Scripts} \\
\hline
 & Write license, community ecosystem, project selection; contribute to code \texttt{Python-Scripts} \\
\hline
 & Write Contribution process description, project selection, contribute to code \texttt{Python-Scripts} \\
\hline
 & Write contribute to \texttt{Python-Scripts}; submit issues to \texttt{Python-Scripts}; document and summarization; \\
\hline
\end{longtable}
